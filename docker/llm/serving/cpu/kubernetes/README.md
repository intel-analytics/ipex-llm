...
To deploy BigDL-LLM-serving cpu in Kubernetes environment, please use this image: `intelanalytics/bigdl-llm-serving-cpu:2.4.0`
...
spec:
  ...
  - name: fastchat-controller # fixed
    image: intelanalytics/bigdl-llm-serving-cpu:2.4.0
