...
/**
  ...
  *
  * @param dim1Crop Int array of length 2. Kernel dim1 of the 3 cropping dimension. Default is (1, 1).
  * @param dim2Crop Int array of length 2. Kernel dim2 of the 3 cropping dimension. Default is (1, 1).
  * @param dim3Crop Int array of length 2. Kernel dim3 of the 3 cropping dimension. Default is (1, 1).
