...
object Sbn {
  def apply[@specialized(Float, Double) T: ClassTag](
    ...
    SpatialBatchNormalization2[T](nOutput)
//    SpatialBatchNormalizationWithRelu[T](nOutput)
    // , eps, momentum, affine).setInitMethod(Ones, Zeros)
  }
}
