...
object Mean {
  def apply[@specialized(Float, Double) T: ClassTag](
      dimension: Int = 1,
      nInputDims: Int = -1,
      squeeze: Boolean = true)(implicit ev: TensorNumeric[T]) : Mean[T, T] = {
    new Mean[T, T](dimension, nInputDims, squeeze)
  }
}
