...
class SpatialBatchNormalization2[T: ClassTag](
  ...
  override def toString(): String = {
    s"nn.SpatialBatchNormalization2($nOutput, $eps, $momentum, $affine)"
  }
...
object SpatialBatchNormalization2 extends ModuleSerializable {
  def apply[@specialized(Float, Double) T: ClassTag](
        ...
        initGradWeight: Tensor[T] = null,
        initGradBias: Tensor[T] = null)(
    implicit ev: TensorNumeric[T]): SpatialBatchNormalization2[T] = {
    new SpatialBatchNormalization2[T](
