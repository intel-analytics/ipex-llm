...
class LSTM2[T : ClassTag] (
  ...
  : (ModuleNode[T], ModuleNode[T], ModuleNode[T], ModuleNode[T]) = {
    ...
    val pi2g1 = lineari2g1_m.parameters()._1
    ...
    val pi2g2 = lineari2g2_m.parameters()._1
    ...
    val pi2g3 = lineari2g1_m.parameters()._1
    ...
    val pi2g4 = lineari2g4_m.parameters()._1
    ...
    val ph2g1 = linearh2g1_m.parameters()._1
    ...
    val ph2g2 = linearh2g2_m.parameters()._1
    ...
    val ph2g3 = linearh2g3_m.parameters()._1
    ...
    val ph2g4 = linearh2g4_m.parameters()._1
