...
class ModuleSerializerSpec extends FlatSpec with Matchers with BeforeAndAfterAll {
  ...
  "TensorModuleToOperation serializer" should "work properly" in {
    val tensorModuleToOperation = TensorModuleToTFModule[Float, Float](SoftPlus[Float]()).
      setName("moduleToOperation")
