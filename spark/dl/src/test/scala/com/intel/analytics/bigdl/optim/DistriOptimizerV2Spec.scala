...
object DistriOptimizerV2SpecModel {
...
class DistriOptimizerV2Spec extends AnyFlatSpec with should.Matchers with BeforeAndAfter {
  ...
  it should "not train model with duplicate layers" in {
    ...
    intercept[IllegalArgumentException] {
      val optimizer = new DistriOptimizerV2[Double](
        m,
        dataSet,
  ...
  "Train with MSE and SGD" should "be trained with good result" in {
    ...
    val optimizer = new DistriOptimizerV2[Double](mm, dataSet, new MSECriterion[Double]())
  ...
  "An Artificial Neural Network with Cross Entropy and LBFGS" should
    ...
    plusOne = 1.0
    val optimizer = new DistriOptimizerV2[Double](cre, dataSet,
  ...
  "setTrainData" should "work properly" in {
    ...
    val myOpt = new DistriOptimizerV2[Double](Identity[Double](), dataSet, null) {
  ...
  "Train with MSE" should "generate correct gradients with l2norm clipping" in {
    ...
    val optimizer2 = new DistriOptimizerV2[Double](mm2, dataSet, new MSECriterion[Double]())
      .setEndWhen(Trigger.maxIteration(1))
  ...
  "optimMethod state" should "be updated correctly after optimize" in {
    ...
    optimizer.resetContext().optimize()
