...
class TestParallel2 extends FlatSpec with Matchers with BeforeAndAfter {
  import TestParallel2._
  import TestParallel2Model._
  ...
  "Train with MSE and SGD" should "be same compare to ref optimizer" in {
