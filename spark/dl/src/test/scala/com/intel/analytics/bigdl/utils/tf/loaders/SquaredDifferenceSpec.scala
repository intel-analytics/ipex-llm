...
class SquaredDifferenceSpec extends TensorflowSpecHelper {
  "SquareDifference forward" should "be correct" in {
    compare(
      NodeDef.newBuilder()
        .setName("SquaredDifferenceTest")
        .setOp("SquaredDifference")
