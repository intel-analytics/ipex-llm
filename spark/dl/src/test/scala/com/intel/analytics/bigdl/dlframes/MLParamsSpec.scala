...
import org.apache.spark.ml.{OptimMethodParam, TriggerParam}
...
class MLParamsSpec extends FlatSpec with Matchers {
  ...
  private class TestMLParams extends Params {
    ...
    final val opt: OptimMethodParam =
      new OptimMethodParam(this, "optimMethod", "Hello guys! I'm a cool optimMethod!")
    ...
    final val trigger: TriggerParam =
      new TriggerParam(this, "trigger", "Hello guys! I'm a cute trigger!")
