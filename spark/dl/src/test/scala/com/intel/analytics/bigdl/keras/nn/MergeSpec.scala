...
class MergeSpec extends KerasBaseSpec {
  ...
  "Merge ave" should "work properly" in {
    ...
    val layer = Merge[Float](layers = List(l1, l2, l3), "ave")
    seq.add(layer)
  ...
  "Merge concat" should "work properly" in {
    ...
    val l2 = InputLayer[Float](inputShape = Shape(4, 8))
    val layer = Merge[Float](layers = List(l1, l2), "concat", concatAxis = 1)
    seq.add(layer)
  ...
  "Merge dot" should "work properly" in {
    ...
    val layer = Merge[Float](layers = List(l1, l2), "dot")
    seq.add(layer)
  ...
  "Merge complicated" should "work properly" in {
    ...
    val layer = Merge[Float](layers = List(l1, l2), "max")
    seq.add(layer)
