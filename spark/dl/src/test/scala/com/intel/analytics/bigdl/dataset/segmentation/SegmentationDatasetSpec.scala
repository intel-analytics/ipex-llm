...
class SegmentationDatasetSpec extends FlatSpec with Matchers with BeforeAndAfter {
  ...
  val rle1 = new RLEMasksFloatTensor(Tensor[Float](_rle1, Array(_rle1.length)), 480, 640)
  val rle2 = new RLEMasksFloatTensor(Tensor[Float](_rle2, Array(_rle2.length)), 480, 640)
