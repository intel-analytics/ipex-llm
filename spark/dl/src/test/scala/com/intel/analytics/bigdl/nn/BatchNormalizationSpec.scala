...
class BatchNormalizationSpec extends FlatSpec with Matchers {
  ...
  "Batch average mean and std" should "work properly" in {
    ...
    // val input = Tensor[Float](2, 64, 112, 112)
    ...
    // val gradOutput = Tensor[Float](2, 64, 112, 112)
 ...
 //   val input1 = Tensor[Float](1, 64, 112, 112).fill(1.0f)
 //   val input2 = Tensor[Float](1, 64, 112, 112).fill(2.0f)
  ...
  //    val gradOutput1 = Tensor[Float](1, 64, 112, 112).fill(1.0f)
   //  val gradOutput2 = Tensor[Float](1, 64, 112, 112).fill(2.0f)
