...
import com.intel.analytics.bigdl.nn.keras.ParametricSoftPlus
import com.intel.analytics.bigdl.tensor.Tensor
import com.intel.analytics.bigdl.utils.Shape

class ParametricSoftPlusSpec extends KerasBaseSpec{

  "ParametricSoftPlus" should "be the same as Keras" in {
    val kerasCode =
      """
  ...
  "ParametricSoftPlus 3D" should "be the same as Keras" in {
    val kerasCode =
      """
      ...
      """.stripMargin
    val seq = KSequential[Float]()
    val parametricsoftplus = ParametricSoftPlus[Float](5.0, inputShape = Shape(3, 24))
    seq.add(parametricsoftplus)
    checkOutputAndGrad(seq.asInstanceOf[AbstractModule[Tensor[Float], Tensor[Float], Float]],
      kerasCode)
  }
