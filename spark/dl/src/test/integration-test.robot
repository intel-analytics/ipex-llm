...
Yarn Test Suite
   ...
   Log To Console                   begin DLClassifierLeNet
   Run Shell                        ${submit} --master yarn --deploy-mode client --conf "spark.serializer=org.apache.spark.serializer.JavaSerializer" --executor-cores 2 --num-executors 2 --driver-memory 150g --executor-memory 2g --class com.intel.analytics.bigdl.example.MLPipeline.DLClassifierLeNet ${jar_path} -b 4 -f ./mnist --maxEpoch 1
   Log To Console                   begin PTBWordLM
