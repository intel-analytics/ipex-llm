...
Spark2.0 Test Suite        Spark2.0 Test Suite                   ${spark_200_3_vid}
Spark2.1 Test Suite        Spark2.1 Test Suite                   ${spark_210_3_vid}
Hdfs Test Suite            Hdfs Test Suite                       ${hdfs_264_3_vid}
Quantization Test Suite    Quantization Test Suite               ${hdfs_264_3_vid}
PySpark2.1 Test Suite      PySpark2.1 Test Suite                 ${spark_tf_210_3_vid}
PySpark1.6 Test Suite      PySpark1.6 Test Suite                 ${spark_tf_163_3_vid}
Yarn Test Suite            Yarn Test Suite                       ${hdfs_264_3_vid}
...
Run Spark Test 
   ...
   Run Shell                        ${submit} --master ${spark_master} --executor-cores 24 --total-executor-cores 24 --driver-memory 60g --executor-memory 200g --class com.intel.analytics.bigdl.example.MLPipeline.DLClassifierLeNet ${jar_path} -b 120 -f ./mnist --maxEpoch 1
   Remove Input
...
PySpark1.6 Test Suite
   ...
   Run Spark Test                   ${submit}                ${spark_tf_163_3_master}
