...
Yarn Test Suite
   ...
   Log To Console                   begin DLClassifierLeNet
   Run Shell                        ${submit} --master yarn --deploy-mode client --conf "spark.serializer=org.apache.spark.serializer.JavaSerializer" --executor-cores 8 --num-executors 8 --driver-memory 150g --executor-memory 2g --class com.intel.analytics.bigdl.example.MLPipeline.DLClassifierLeNet ${jar_path} -b 16 -f ./mnist --maxEpoch 1
   Log To Console                   begin PTBWordLM
   Run Shell                        ${submit} --master yarn --deploy-mode client --conf "spark.serializer=org.apache.spark.serializer.JavaSerializer" --executor-cores 8 --num-executors 8 --driver-memory 150g --executor-memory 2g --class com.intel.analytics.bigdl.example.languagemodel.PTBWordLM ${jar_path} -f ./simple-examples/data -b 16 --numLayers 2 --vocab 10001 --hidden 650 --numSteps 35 --learningRate 0.005 -e 1 --learningRateDecay 0.001 --keepProb 0.5 --overWrite
   Log To Console                   begin inceptionV1 train
   Run Shell                        ${submit} --master yarn --deploy-mode client --conf "spark.serializer=org.apache.spark.serializer.JavaSerializer" --executor-cores 8 --num-executors 8 --driver-memory 150g --executor-memory 2g --class com.intel.analytics.bigdl.models.inception.TrainInceptionV1 ${jar_path} -b 16 -f ${imagenet_test_data_source} --learningRate 0.1 -e 1
   Log To Console                   begin text classification
