...
Run Spark Test 
   ...
   Run Shell                        ${submit} --master ${spark_master} --driver-memory 5g --executor-memory 30g --total-executor-cores 32 --executor-cores 16 --class com.intel.analytics.bigdl.example.textclassification.TextClassifier ${jar_path} --batchSize 128 --baseDir /tmp/text_data --partitionNum 32
   Remove Input
