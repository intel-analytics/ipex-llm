...
> [!TIP]
> When your machine has multi GPUs and you want to run on one of them, you need to `export ONEAPI_DEVICE_SELECTOR=level_zero:[gpu_id]`, here `[gpu_id]` varies based on your requirement. For more details, you can refer to [this section](../Overview/KeyFeatures/multi_gpus_selection.md/multi_gpus_selection.md#2-oneapi-device-selector)
