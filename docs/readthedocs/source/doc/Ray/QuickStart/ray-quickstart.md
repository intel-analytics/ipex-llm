...
This is the only place where you need to specify local or distributed mode. See [here](./../../Orca/Overview/ray.md#initialize) for more RayOnSpark related arguments when you `init_orca_context`.
