...
* `How to conduct BFloat16 Mixed Precision inference in a TensorFlow application for acceleration <Inference/TensorFlow/accelerate_tensorflow_inference_bf16.html>`_
