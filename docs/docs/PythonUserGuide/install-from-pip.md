...
- This package is built with __JDK7__ by default, so you need to install Java __>= JDK7__ before runing BigDL.
...
pip3 install BigDL==0.4.0.dev0    # for Python 3.5 and Python 3.6
```
