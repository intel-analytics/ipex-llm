...
Note that the essential dependencies (including `ray==1.2.0`, `psutil`, `aiohttp`, `setproctitle`, `pyarrow==0.17.0`) will be installed by specifying the extras key `[ray]` when you pip install analytics-zoo.
