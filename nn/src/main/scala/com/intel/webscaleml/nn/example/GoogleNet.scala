...
object GoogleNet {
  def getModel[D : ClassTag](classNum : Int, modelName: String = "")(implicit ev: TensorNumeric[D]) : Module[D] = {
    modelName match {
      case "googlenet-bn" => {
        def inception(inputSize : Int, config : Table)(implicit ev: TensorNumeric[D]) : Module[D] = {
          ...
          conv3.add(new SpatialConvolution[D](config[Table](2)(1), config[Table](2)(2), 3, 3, 1, 1, 1, 1))
          ...
          conv3xx.add(new SpatialConvolution[D](config[Table](3)(1), config[Table](3)(2), 3, 3, 1, 1, 1, 1))
          conv3xx.add(new SpatialBatchNormalization(config[Table](3)(2), 1e-3))
          conv3xx.add(new ReLU[D](true))

          conv3xx.add(new SpatialConvolution[D](config[Table](3)(2), config[Table](3)(2), 3, 3, 1, 1, 1, 1))
          conv3xx.add(new SpatialBatchNormalization(config[Table](3)(2), 1e-3))
          conv3xx.add(new ReLU[D](true))
          concat.add(conv3xx)
  ...
  def inception[D : ClassTag](inputSize : Int, config : Table)(implicit ev: TensorNumeric[D]) : Module[D] = {
    val concat = new Concat[D](2)
    if(config[Table](1)[Int](1) != 0) {
      val conv1 = new Sequential[D]
      conv1.add(new SpatialConvolution[D](inputSize, config[Table](1)(1), 1, 1, 1, 1))
  ...
  def getModelCaffe[D : ClassTag](classNum : Int)(implicit ev: TensorNumeric[D]) : Module[D] = {
    ...
    //features.add(new LocalNormalizationAcrossChannels[D](5, 0.0001, 0.75))
