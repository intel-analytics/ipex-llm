...
object AllReduceParameter2 {
  ...
  def newParameter[T: ClassTag](parationNum: Int, size: Int): AllReduceParameter2[T] = {
    new AllReduceParameter2(nextId.getAndIncrement(), parationNum, size)
  }
}

class AllReduceParameter2[T: ClassTag](id: Long, partitionNum: Int,
  size: Int) extends Serializable {
  import AllReduceParameter2._
