...
object GoogleNet_v1 {
  private def inception[D: ClassTag](inputSize: Int, config: Table, namePrefix : String)(
    ...
    val conv1 = Sequential[Tensor[D], Tensor[D], D]
    ...
    concat.add(conv1)
    val conv3 = Sequential[Tensor[D], Tensor[D], D]
    ...
    concat.add(conv3)
    val conv5 = Sequential[Tensor[D], Tensor[D], D]
    ...
    concat.add(conv5)
    val pool = Sequential[Tensor[D], Tensor[D], D]
  ...
  def apply[D: ClassTag](classNum: Int)
    (implicit ev: TensorNumeric[D]): Module[Tensor[D], Tensor[D], D] = {
    val feature1 = Sequential[Tensor[D], Tensor[D], D]
    ...
    val output1 = Sequential[Tensor[D], Tensor[D], D]
    ...
    val feature2 = Sequential[Tensor[D], Tensor[D], D]
    ...
    val output2 = Sequential[Tensor[D], Tensor[D], D]
    ...
    val output3 = Sequential[Tensor[D], Tensor[D], D]
    ...
    val mainBranch = Sequential[Tensor[D], Tensor[D], D]()
    ...
    val model = Sequential[Tensor[D], Tensor[D], D]()
...
object GoogleNet_v2_NoAuxClassifier {
  ...
  def inception[D: ClassTag](inputSize: Int, config: Table, namePrefix : String)(
    ...
    val conv3xx = Sequential[Tensor[D], Tensor[D], D]
...
object GoogleNet_v2 {
  def apply[D: ClassTag](classNum: Int)
    (implicit ev: TensorNumeric[D]): Module[Tensor[D], Tensor[D], D] = {
    val features1 = Sequential[Tensor[D], Tensor[D], D]
    ...
    val features2 = Sequential[Tensor[D], Tensor[D], D]
