...
class Linear[@specialized(Float, Double) T: ClassTag](
  ...
  override def updateOutput(input: Tensor[T]): Tensor[T] ={
    ...
    if (firstPass) {
      ev.getType() match {
        case "Double" => classPtr = MKL.LinearInitDouble(inputHeight, inputWidth, outputChannels,
          kernelHeight, kernelWidth)
        case "Float" => classPtr = MKL.LinearInitFloat(inputHeight, inputWidth, outputChannels,
          kernelHeight, kernelWidth)
    ...
    ev.getType() match {
      case "Double" => MKL.LinearForwardDouble(
        ...
        classPtr)
      case "Float" => MKL.LinearForwardFloat(
  ...
  override def updateGradInput(input: Tensor[T], gradOutput: Tensor[T]): Tensor[T] ={
    ...
    if(needCompute) {
      ev.getType() match {
        case "Double" => MKL.LinearBackwardDataDouble(
          input.storage().array().asInstanceOf[Array[Double]], inputOffset,
        ...
        case "Float" => MKL.LinearBackwardDataFloat(
          input.storage().array().asInstanceOf[Array[Float]], inputOffset,
    ...
    ev.getType() match {
      case "Double" => MKL.LinearBackwardKernelDouble(
        input.storage().array().asInstanceOf[Array[Double]], inputOffset,
        gradOutput.storage().array().asInstanceOf[Array[Double]], gradOutputOffset,
        gradWeight.storage().array().asInstanceOf[Array[Double]], gradWeightOffset,
        weight.storage().array().asInstanceOf[Array[Double]], kernelOffset,
        bias.storage().array().asInstanceOf[Array[Double]], biasOffset,
        classPtr)

      case "Float" => MKL.LinearBackwardKernelFloat(
        input.storage().array().asInstanceOf[Array[Float]], inputOffset,
        gradOutput.storage().array().asInstanceOf[Array[Float]], gradOutputOffset,
        gradWeight.storage().array().asInstanceOf[Array[Float]], gradWeightOffset,
        weight.storage().array().asInstanceOf[Array[Float]], kernelOffset,
        bias.storage().array().asInstanceOf[Array[Float]], biasOffset,
        classPtr)
    ...
    ev.getType() match {
      case "Double" => MKL.LinearBackwardBiasDouble(
        input.storage().array().asInstanceOf[Array[Double]], inputOffset,
        gradOutput.storage().array().asInstanceOf[Array[Double]], gradOutputOffset,
      ...
      case "Float" => MKL.LinearBackwardBiasFloat(
        input.storage().array().asInstanceOf[Array[Float]], inputOffset,
        gradOutput.storage().array().asInstanceOf[Array[Float]], gradOutputOffset,
