...
object DenseTensorApply {
  /**
    ...
    */
    def apply1[@specialized(Float, Double) T](tensor : DenseTensor[T], func : TensorFunc2[T] ) : Unit = {
...
//  def apply4[@specialized(Float, Double) T](tensor : DenseTensor[T], func : (Int) => Unit ) : Unit = {
//
//    if(tensor.nDimension == 0)
//      return
//
...
//  }
   ...
   */
  def apply2[@specialized(Float, Double) T](tensor1 : DenseTensor[T], tensor2 : Tensor[T], func : TensorFunc4[T] ) : Unit = {
    ...
    while (!hasFinished) {
      while (i1 < largestSize1 && i2 < largestSize2) {
        func(tensor1Data, tensor1Offset + i1 * tensor1Stride, tensor2Data, tensor2Offset + i2 * tensor2Stride)
        i1 = i1 + 1
        i2 = i2 + 1
      }
...
//  def apply5[@specialized(Float, Double) T](tensor1 : DenseTensor[T], tensor2 : Tensor[T], func : (Int, Int) => Unit ) : Unit = {
//    require(tensor1.nElement() == tensor2.nElement(), "inconsistent tensor size")
//
//    if (tensor1.nDimension == 0)
//      return
...
//      var i = 0
//      while(i < tensor1.nElement()) {
//        func(tensor1Offset + i, tensor2Offset + i)
//        i += 1
//      }
//      return
//    }
...
//    while (!hasFinished) {
//      while (i1 < largestSize1 && i2 < largestSize2) {
//        func(tensor1Offset + i1 * tensor1Stride, tensor2Offset + i2 * tensor2Stride)
//        i1 = i1 + 1
//        i2 = i2 + 1
//      }
//
...
//  }
   ...
   * @param func (tensor1Data, tensor1Offset, tensor2Data, tensor2Offset, tensor3Data, tensor3Offset)
   */
  private[tensor] def apply3[@specialized(Float, Double) T](tensor1 : DenseTensor[T], tensor2 : Tensor[T], tensor3 : Tensor[T],
    func : TensorFunc6[T] ) : Unit = {

    require(tensor1.nElement() == tensor2.nElement() && tensor2.nElement() == tensor3.nElement(), "inconsistent tensor size")
    ...
    val tensor3Data = tensor3.storage().asInstanceOf[Storage[T]].array()
