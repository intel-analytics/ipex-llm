...
import com.intel.analytics.dllib.lib.example.GoogleNet
...
class GoogleNetSpec extends FlatSpec with BeforeAndAfter with Matchers{
  ...
  "GoogleNet+bn" should "generate correct output" in {
    ...
    TH.runNM(code, Map("input"->input, "labels"->labels), Array("output", "gradOutput","err","parameters_initial","gradParameters_initial", "gradParameters", "parameters", "model2"))
  ...
  "GoogleNet" should "generate correct output" in {
    ...
    TH.runNM(code, Map("input"->input, "labels"->labels), Array("output", "gradOutput","err","parameters_initial","gradParameters_initial", "gradInput", "parameters"))
