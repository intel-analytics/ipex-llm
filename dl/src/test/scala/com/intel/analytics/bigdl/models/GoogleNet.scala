...
object GoogleNet_v1 {
  ...
  def apply[D: ClassTag](classNum: Int)
    ...
    feature1.add(new SpatialConvolution[D](3, 64, 7, 7, 2, 2, 3, 3, 1, true).setInitMethod(Xavier)
...
object GoogleNet_v2_NoAuxClassifier {
  def apply[D: ClassTag](classNum: Int)
    ...
    model.add(new SpatialConvolution[D](3, 64, 7, 7, 2, 2, 3, 3, 1, true)
      .setName("conv1/7x7_s2"))
    val tmp = new SpatialBatchNormalization(64, 1e-3).setName("conv1/7x7_s2/bn")
  ...
  def inception[D: ClassTag](inputSize: Int, config: Table, namePrefix : String)(
    ...
    if (config[Table](1)[Int](1) != 0) {
      ...
      conv1.add(new SpatialBatchNormalization(config[Table](1)(1), 1e-3).setName(namePrefix + "1x1/bn"))
    ...
    conv3.add(new SpatialBatchNormalization(config[Table](2)(1), 1e-3).setName(namePrefix + "3x3_reduce/bn"))
    ...
    conv3.add(new SpatialBatchNormalization(config[Table](2)(2), 1e-3).setName(namePrefix + "3x3/bn"))
    ...
    conv3xx.add(new SpatialBatchNormalization(config[Table](3)(1), 1e-3).setName(namePrefix + "double3x3_reduce/bn"))
    ...
    conv3xx.add(new SpatialBatchNormalization(config[Table](3)(2), 1e-3).setName(namePrefix + "double3x3a/bn"))
    ...
    conv3xx.add(new SpatialBatchNormalization(config[Table](3)(2), 1e-3).setName(namePrefix + "double3x3b/bn"))
    ...
    if (config[Table](4)[Int](2) != 0) {
      ...
      pool.add(new SpatialBatchNormalization(config[Table](4)(2), 1e-3).setName(namePrefix + "pool_proj/bn"))
      ...
      case "googlenet-bn" =>
        def inception(inputSize: Int, config: Table)(
          ...
          if (config[Table](1)[Int](1) != 0) {
            val conv1 = new Sequential[Tensor[D], Tensor[D], D]
            conv1.add(new SpatialConvolution[D](inputSize, config[Table](1)(1), 1, 1, 1, 1))
            val bn = new SpatialBatchNormalization(config[Table](1)(1), 1e-3)
            bn.setInit()
            conv1.add(bn)
          ...
          val conv3 = new Sequential[Tensor[D], Tensor[D], D]
          conv3.add(new SpatialConvolution[D](inputSize, config[Table](2)(1), 1, 1, 1, 1))
          var bn = new SpatialBatchNormalization(config[Table](2)(1), 1e-3)
          bn.setInit()
          conv3.add(bn)
          conv3.add(new ReLU[D](true))
          conv3.add(new SpatialConvolution[D](config[Table](2)(1),
            config[Table](2)(2), 3, 3, 1, 1, 1, 1))
          bn = new SpatialBatchNormalization(config[Table](2)(2), 1e-3)
          bn.setInit()
          conv3.add(bn)
          conv3.add(new ReLU[D](true))
          concat.add(conv3)
          ...
          val conv3xx = new Sequential[Tensor[D], Tensor[D], D]
          conv3xx.add(new SpatialConvolution[D](inputSize, config[Table](3)(1), 1, 1, 1, 1))
          bn = new SpatialBatchNormalization(config[Table](3)(1), 1e-3)
          bn.setInit()
          conv3xx.add(bn)
          ...
          bn = new SpatialBatchNormalization(config[Table](3)(2), 1e-3)
          bn.setInit()
          conv3xx.add(bn)
          conv3xx.add(new ReLU[D](true))
          ...
          if (config[Table](4)[Int](2) != 0) {
            pool.add(new SpatialConvolution[D](inputSize, config[Table](4)[Int](2), 1, 1, 1, 1))
            bn = new SpatialBatchNormalization(config[Table](4)(2), 1e-3)
            bn.setInit()
            pool.add(bn)
        ...
        var bn = new SpatialBatchNormalization(64, 1e-3)
        bn.setInit()
        features.add(bn)
        ...
        bn = new SpatialBatchNormalization(192, 1e-3)
        bn.setInit()
        features.add(bn)
        features.add(new ReLU[D](true))
        features.add(new SpatialMaxPooling[D](3, 3, 2, 2).ceil())
        ...
        bn = new SpatialBatchNormalization(1024, 1e-3)
        bn.setInit()
        mainBranch.add(bn)
        ...
        bn = new SpatialBatchNormalization(128, 1e-3)
        bn.setInit()
        auxClassifier.add(bn)
