...
object GoogleNet_v1 {
  ...
  def apply[D: ClassTag](classNum: Int)
    ...
    feature1.add(new SpatialConvolution[D](3, 64, 7, 7, 2, 2, 3, 3, 1, true)
      .setInitMethod(Xavier).setName("conv1/7x7_s2"))
    ...
    feature1.add(new SpatialConvolution[D](64, 64, 1, 1, 1, 1)
      .setInitMethod(Xavier).setName("conv2/3x3_reduce"))
    feature1.add(new ReLU[D](true).setName("conv2/relu_3x3_reduce"))
    feature1.add(new SpatialConvolution[D](64, 192, 3, 3, 1, 1, 1, 1)
      .setInitMethod(Xavier).setName("conv2/3x3"))
...
object GoogleNet_v2 {
  def apply[D: ClassTag](classNum: Int)
    ...
    features1.add(new SpatialConvolution[D](3, 64, 7, 7, 2, 2, 3, 3, 1, true)
      .setName("conv1/7x7_s2"))
    features1.add(new SpatialBatchNormalization(64, 1e-3).setInit().setName("conv1/7x7_s2/bn"))
    ...
    features1.add(new SpatialBatchNormalization(64, 1e-3).setInit().setName("conv2/3x3_reduce/bn"))
    ...
    features1.add(new SpatialBatchNormalization(192, 1e-3).setInit().setName("conv2/3x3/bn"))
    ...
    output1.add(new SpatialBatchNormalization(128, 1e-3).setInit().setName("loss1/conv/bn"))
    ...
    output2.add(new SpatialBatchNormalization(128, 1e-3).setInit().setName("loss2/conv/bn"))
  ...
  def inception[D: ClassTag](inputSize: Int, config: Table, namePrefix : String)(
    ...
    if (config[Table](1)[Int](1) != 0) {
      ...
      conv1.add(new SpatialBatchNormalization(config[Table](1)(1), 1e-3).setInit()
    ...
    conv3.add(new SpatialBatchNormalization(config[Table](2)(1), 1e-3).setInit()
    ...
    conv3.add(new SpatialBatchNormalization(config[Table](2)(2), 1e-3).setInit()
    ...
    conv3xx.add(new SpatialBatchNormalization(config[Table](3)(1), 1e-3).setInit()
    ...
    conv3xx.add(new SpatialBatchNormalization(config[Table](3)(2), 1e-3).setInit()
    ...
    if (config[Table](4)[Int](2) != 0) {
      ...
      pool.add(new SpatialBatchNormalization(config[Table](4)(2), 1e-3).setInit()
  ...
  def applyNoBn[D: ClassTag](classNum: Int)
                        (implicit ev: TensorNumeric[D]): Module[Tensor[D], Tensor[D], D] = {
    val features1 = new Sequential[Tensor[D], Tensor[D], D]
    features1.add(new SpatialConvolution[D](3, 64, 7, 7, 2, 2, 3, 3, 1, true)
      .setName("conv1/7x7_s2"))
    ...
    features1.add(new ReLU[D](true).setName("conv2/3x3/bn/sc/relu"))
    features1.add(new SpatialMaxPooling[D](3, 3, 2, 2).ceil().setName("pool2/3x3_s2"))
    features1.add(inceptionNoBn(192, T(T(64), T(64, 64), T(64, 96), T("avg", 32)), "inception_3a/"))
    features1.add(inceptionNoBn(256, T(T(64), T(64, 96), T(64, 96), T("avg", 64)), "inception_3b/"))
    features1.add(inceptionNoBn(320, T(T(0), T(128, 160), T(64, 96), T("max", 0)), "inception_3c/"))
    ...
    val features2 = new Sequential[Tensor[D], Tensor[D], D]
    features2.add(inceptionNoBn(576, T(T(224), T(64, 96), T(96, 128), T("avg", 128)),
       "inception_4a/"))
    features2.add(inceptionNoBn(576, T(T(192), T(96, 128), T(96, 128), T("avg", 128)),
       "inception_4b/"))
    features2.add(inceptionNoBn(576, T(T(160), T(128, 160), T(128, 160), T("avg", 96)),
      "inception_4c/"))
    features2.add(inceptionNoBn(576, T(T(96), T(128, 192), T(160, 192), T("avg", 96)),
      "inception_4d/"))
    features2.add(inceptionNoBn(576, T(T(0), T(128, 192), T(192, 256), T("max", 0)),
      "inception_4e/"))
  ...
  def inceptionNoBn[D: ClassTag](inputSize: Int, config: Table, namePrefix : String)(
    implicit ev: TensorNumeric[D]): Module[Tensor[D], Tensor[D], D] = {
    val concat = new Concat[D](2)
    if (config[Table](1)[Int](1) != 0) {
      val conv1 = new Sequential[Tensor[D], Tensor[D], D]
  ...
  def getModel[D: ClassTag](classNum: Int, modelName: String = "")(
    ...
    modelName match {
      case "googlenet-bn" =>
        ...
        features.add(new SpatialBatchNormalization(64, 1e-3).setInit())
        ...
        features.add(new SpatialBatchNormalization(192, 1e-3).setInit())
        features.add(new ReLU[D](true))
        features.add(new SpatialMaxPooling[D](3, 3, 2, 2).ceil())
        ...
        mainBranch.add(new SpatialBatchNormalization(1024, 1e-3).setInit())
        ...
        auxClassifier.add(new SpatialBatchNormalization(128, 1e-3).setInit())
