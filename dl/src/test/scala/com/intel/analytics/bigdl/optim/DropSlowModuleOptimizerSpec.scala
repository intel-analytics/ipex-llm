...
object DropSlowModuleOptimizerSpec {
...
class DropSlowModuleOptimizerSpec extends FlatSpec with Matchers with BeforeAndAfter
  ...
  before {
    ...
    DropSlowModuleGradAggEpochOptimizer.subModuleNumber = subModuleNumber
  ...
  "An Artificial Neural Network with MSE and LBFGS" should "be trained with good result" in {
    ...
    mseWeight.copy(optimizer.parameters)
  ...
  "An Artificial Neural Network with Cross Entropy and LBFGS" should
    ...
    crnWeight.copy(optimizer.parameters)
