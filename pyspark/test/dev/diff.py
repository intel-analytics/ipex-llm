...
def extract_scala_class(class_path):
    exclude_key_words = set(["*", "abstract", "Const", "Fill", "Shape",
                             ...
                             "SplitHeads", "CombineHeads", "InternalMulTable",
                             "LayerLinear", "LayerNormalization", "TransformerConstant",
                             "TransformerPrepareDecoder", "InternalExpand", "InternalCSubTable"])   # noqa
