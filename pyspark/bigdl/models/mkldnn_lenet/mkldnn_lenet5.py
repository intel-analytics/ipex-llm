...
if __name__ == "__main__":
    ...
    parser.add_option("-o", "--modelPath", dest="modelPath", default="/tmp/mkldnn_lenet5/model.939")
    parser.add_option("-c", "--checkpointPath", dest="checkpointPath", default="/tmp/mkldnn_lenet5")
    ...
    sc = SparkContext(appName="mkldnn_lenet5", conf=create_spark_conf())
    redire_spark_logs()
