...
### Run via pip install
- Check [Install from pip](https://bigdl-project.github.io/0.6.0-SNAPSHOT/#PythonUserGuide/install-from-pip/)
- Check [Run after pip install](https://bigdl-project.github.io/0.6.0-SNAPSHOT/#PythonUserGuide/run-from-pip/)
...
- Check [Install without pip](https://bigdl-project.github.io/0.6.0-SNAPSHOT/#PythonUserGuide/install-without-pip/)
- Check [Run without pip ](https://bigdl-project.github.io/0.6.0-SNAPSHOT/#PythonUserGuide/run-without-pip/)
