...
For demo purposes, we will skip building the custom image here and use the public reference image provided by BigDL PPML `intelanalytics/bigdl-ppml-trusted-bigdata-gramine-reference-8g:2.4.0` to have a quick start.
...
export DOCKER_IMAGE=intelanalytics/bigdl-ppml-trusted-big-data-ml-python-gramine-reference:2.4.0
...
1. Prepare BigDL Base Image
    ...
    You can use our public bigdata base image `intelanalytics/bigdl-ppml-trusted-bigdata-gramine-base:2.4.0`, which is recommended. Or you can build your own base image, which is expected to be exactly the same as ours.
...
Attributes:
    ...
    export DOCKER_IMAGE=intelanalytics/bigdl-ppml-trusted-bigdata-gramine-reference-8g:2.4.0 # or the custom image built by yourself
