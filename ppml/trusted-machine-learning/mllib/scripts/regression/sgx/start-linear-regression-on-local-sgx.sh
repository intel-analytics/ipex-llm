#!/bin/bash
# source code link: https://github.com/apache/spark/blob/master/examples/src/main/scala/org/apache/spark/examples/ml/LinearRegressionWithElasticNetExample.scala
cd /ppml
...
input_file="data/mllib/sample_linear_regression_data.txt"

if [ -f "$input_file" ]; then
    echo "Input file exists."
else
    echo "Input file not exists, downloading the file"
    wget https://raw.githubusercontent.com/apache/spark/master/data/mllib/sample_linear_regression_data.txt -O "$input_file"
fi
...
export sgx_command="/opt/jdk8/bin/java \
    ...
    --executor-cores 8 \
    --num-executors 2 \
    --class org.apache.spark.examples.ml.LinearRegressionWithElasticNetExample \
