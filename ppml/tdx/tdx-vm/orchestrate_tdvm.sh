...
wget http://10.239.45.10:8081/repository/raw/bigdl/tdx-vm/td-guest-ubuntu-22.04.qcow2.tar.xz -O ~/tdx-vm/td-guest-ubuntu-22.04.qcow2.tar.xz
...
wget http://10.239.45.10:8081/repository/raw/bigdl/tdx-vm/vmlinuz-jammy -O ~/tdx-vm/vmlinuz-jammy

echo downloading tdx.xml
wget http://10.239.45.10:8081/repository/raw/bigdl/tdx-vm/tdx.xml -O ~/tdx-vm/tdx.xml
