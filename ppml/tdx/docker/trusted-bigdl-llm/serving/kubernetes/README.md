...
To deploy trusted bigdl-llm serving tdx service in Kubernetes environment, please use this image: `intelanalytics/bigdl-ppml-trusted-bigdl-llm-serving-tdx:2.4.0`
...
spec:
  ...
  - name: trusted-bigdl-llm-serving-tdx-controller # fixed
    image: intelanalytics/bigdl-ppml-trusted-bigdl-llm-serving-tdx:2.4.0
    securityContext:
      privileged: true
      runAsUser: 0
