...
Proxy_Modified="sudo docker build \
    ...
    -t intelanalytics/bigdl-ppml-trusted-dl-serving:2.3.0-SNAPSHOT -f ./Dockerfile ."

No_Proxy_Modified="sudo docker build \
    --build-arg no_proxy=x.x.x.x \
    -t intelanalytics/bigdl-ppml-trusted-dl-serving:2.3.0-SNAPSHOT:2.3.0-SNAPSHOT -f ./Dockerfile ."
