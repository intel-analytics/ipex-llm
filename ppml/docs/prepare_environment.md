...
Pull Docker image from Dockerhub
    ```
    docker pull intelanalytics/bigdl-ppml-trusted-bigdata-gramine-reference-8g:2.4.0
    ```

**Note:** The above docker image `intelanalytics/bigdl-ppml-trusted-bigdata-gramine-reference-8g:2.4.0` is only used for demo purposes. You are recommended to refer to the [Prepare your PPML image for production environment](./../README.md#step-1-prepare-your-ppml-image-for-production-environment) to use BigDL PPML image as a base image to build your own image and sign your image with your own enclave_key.
