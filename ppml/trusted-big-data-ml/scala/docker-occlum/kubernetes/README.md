...
* Prepare image `intelanalytics/bigdl-ppml-trusted-big-data-ml-scala-occlum:2.4.0`

1. Pull image from Dockerhub

```bash
docker pull intelanalytics/bigdl-ppml-trusted-big-data-ml-scala-occlum:2.4.0
```
