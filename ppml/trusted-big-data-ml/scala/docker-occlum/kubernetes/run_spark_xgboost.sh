...
${SPARK_HOME}/bin/spark-submit \
    ...
    --conf spark.kubernetes.container.image=intelanalytics/bigdl-ppml-trusted-big-data-ml-scala-occlum:2.2.0 \
    ...
    local:/bin/jars/bigdl-dllib-spark_3.1.3-2.2.0.jar \
