...
${SPARK_HOME}/bin/spark-submit \
    ...
    --conf spark.kubernetes.driver.podTemplateFile=./executor_spark-logisticregressionexample.yaml \
    --conf spark.kubernetes.executor.podTemplateFile=./executor_spark-logisticregressionexample.yaml \
