...
init_instance() {
    ...
    new_json="$(jq '.resource_limits.user_space_size = "SGX_MEM_SIZE" |
        ...
        .env.untrusted = [ "PYTHONPATH=/host/data1/FastChat", "OMP_NUM_THREADS", "KUBECONFIG", "MALLOC_ARENA_MAX", "ATTESTATION_DEBUG", "DMLC_TRACKER_URI", "SPARK_DRIVER_URL", "SPARK_TESTING" , "_SPARK_AUTH_SECRET" ] |
