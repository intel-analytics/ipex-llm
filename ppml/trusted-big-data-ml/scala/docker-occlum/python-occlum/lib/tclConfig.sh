...
# installed.
TCL_PREFIX='/root/demos/python/python_glibc1/python-occlum'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/root/demos/python/python_glibc1/python-occlum'
...
TCL_EXTRA_CFLAGS='-march=nocona -mtune=haswell -ftree-vectorize -fPIC -fstack-protector-strong -fno-plt -O2 -ffunction-sections -pipe -isystem /root/demos/python/python_glibc1/python-occlum/include -fdebug-prefix-map=/opt/conda/conda-bld/tk_1654088763175/work=/usr/local/src/conda/tk-8.6.12 -fdebug-prefix-map=/root/demos/python/python_glibc1/python-occlum=/usr/local/src/conda-prefix -pipe -m64 -DNDEBUG -D_FORTIFY_SOURCE=2 -O2 -isystem /root/demos/python/python_glibc1/python-occlum/include'
...
TCL_LD_FLAGS='-Wl,-O2 -Wl,--sort-common -Wl,--as-needed -Wl,-z,relro -Wl,-z,now -Wl,--disable-new-dtags -Wl,--gc-sections -Wl,-rpath,/root/demos/python/python_glibc1/python-occlum/lib -Wl,-rpath-link,/root/demos/python/python_glibc1/python-occlum/lib -L/root/demos/python/python_glibc1/python-occlum/lib -Wl,--export-dynamic '
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/root/demos/python/python_glibc1/python-occlum/lib -ltcl8.6'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/root/demos/python/python_glibc1/python-occlum/include'
...
TCL_PACKAGE_PATH='{/root/demos/python/python_glibc1/python-occlum/lib} '
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/root/demos/python/python_glibc1/python-occlum/lib -ltclstub8.6'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/opt/conda/conda-bld/tk_1654088763175/work/tcl8.6.12/unix/libtclstub8.6.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/root/demos/python/python_glibc1/python-occlum/lib/libtclstub8.6.a'
