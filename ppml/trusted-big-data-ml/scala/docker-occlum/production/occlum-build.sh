# default
export container_name=2.2.0-build-container
export image_name=intelanalytics/bigdl-ppml-trusted-big-data-ml-scala-occlum-production:2.2.0
export final_name=intelanalytics/bigdl-ppml-trusted-big-data-ml-scala-occlum-production:2.2.0-build
