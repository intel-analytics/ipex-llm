...
def get_args():
    ...
    parser.add_argument('-efp', '--efp', type=str, help='path of the encrypted file to decrypt', required=True)
...
if __name__ == "__main__":
    ...
    decrypt_file(ip, port, pkp, dkp, efp)
