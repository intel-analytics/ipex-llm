...
/graphene/Tools/argv_serializer bash -c "/opt/jdk8/bin/java \
  ...
  org.apache.spark.deploy.SparkSubmit \
    ...
    /ppml/trusted-big-data-ml/work/examples/sql_example.py" > /ppml/trusted-big-data-ml/secured-argvs
./init.sh
SGX=1 ./pal_loader bash 2>&1 | tee test-sql-dataframe-sgx.log
...
/graphene/Tools/argv_serializer bash -c "/opt/jdk8/bin/java \
  ...
  org.apache.spark.deploy.SparkSubmit \
    ...
    --conf spark.python.worker.reuse=false \
    --conf spark.sql.broadcastTimeout=3000 \
    /ppml/trusted-big-data-ml/work/examples/sql_context_example.py" > /ppml/trusted-big-data-ml/secured-argvs
./init.sh
SGX=1 ./pal_loader bash 2>&1 | tee test-sql-context-sgx.log
...
/graphene/Tools/argv_serializer bash -c "/opt/jdk8/bin/java \
  ...
  -Xmx1g \
    ...
    --conf spark.python.use.daemon=false \
    --conf spark.python.worker.reuse=false \
    /ppml/trusted-big-data-ml/work/examples/sql_UDFRegistration_example.py" > /ppml/trusted-big-data-ml/secured-argvs
./init.sh
SGX=1 ./pal_loader bash 2>&1 | tee test-sql-UDFRegistration.log
...
/graphene/Tools/argv_serializer bash -c "/opt/jdk8/bin/java \
  ...
  org.apache.spark.deploy.SparkSubmit \
    ...
    --conf spark.python.use.daemon=false \
    --conf spark.python.worker.reuse=false \
    /ppml/trusted-big-data-ml/work/examples/sql_groupeddata_example.py" > /ppml/trusted-big-data-ml/secured-argvs
./init.sh
SGX=1 ./pal_loader bash 2>&1 | tee test-sql-groupeddata-sgx.log
...
/graphene/Tools/argv_serializer bash -c "/opt/jdk8/bin/java \
  ...
  org.apache.spark.deploy.SparkSubmit \
    ...
    --conf spark.python.use.daemon=false \
    --conf spark.python.worker.reuse=false \
    /ppml/trusted-big-data-ml/work/examples/sql_column_example.py" > /ppml/trusted-big-data-ml/secured-argvs
./init.sh
SGX=1 ./pal_loader bash 2>&1 | tee test-sql-column-sgx.log
...
/graphene/Tools/argv_serializer bash -c "/opt/jdk8/bin/java \
  ...
  org.apache.spark.deploy.SparkSubmit \
    ...
    --conf spark.python.use.daemon=false \
    --conf spark.python.worker.reuse=false \
    /ppml/trusted-big-data-ml/work/examples/sql_row_func_example.py" > /ppml/trusted-big-data-ml/secured-argvs
./init.sh
SGX=1 ./pal_loader bash 2>&1 | tee test-sql-row-sgx.log
...
/graphene/Tools/argv_serializer bash -c "/opt/jdk8/bin/java \
  ...
  org.apache.spark.deploy.SparkSubmit \
    ...
    --conf spark.python.use.daemon=false \
    --conf spark.python.worker.reuse=false \
    /ppml/trusted-big-data-ml/work/examples/sql_window_example.py" > /ppml/trusted-big-data-ml/secured-argvs
./init.sh
SGX=1 ./pal_loader bash 2>&1 | tee test-window-sgx.log
...
/graphene/Tools/argv_serializer bash -c "/opt/jdk8/bin/java \
  ...
  org.apache.spark.deploy.SparkSubmit \
    ...
    --conf spark.python.use.daemon=false \
    --conf spark.python.worker.reuse=false \
    /ppml/trusted-big-data-ml/work/examples/sql_dataframe_reader_example.py" > /ppml/trusted-big-data-ml/secured-argvs
./init.sh
SGX=1 ./pal_loader bash 2>&1 | tee test-dataframe-reader-sgx.log
...
/graphene/Tools/argv_serializer bash -c "/opt/jdk8/bin/java \
  ...
  org.apache.spark.deploy.SparkSubmit \
    ...
    --conf spark.python.use.daemon=false \
    --conf spark.python.worker.reuse=false \
    /ppml/trusted-big-data-ml/work/examples/sql_dataframe_writer_example.py" > /ppml/trusted-big-data-ml/secured-argvs
./init.sh
SGX=1 ./pal_loader bash 2>&1 | tee test-dataframe-writer-sgx.log
...
/graphene/Tools/argv_serializer bash -c "/opt/jdk8/bin/java \
  ...
  org.apache.spark.deploy.SparkSubmit \
    ...
    --conf spark.python.use.daemon=false \
    --conf spark.python.worker.reuse=false \
    /ppml/trusted-big-data-ml/work/examples/sql_hive_context_example.py" > /ppml/trusted-big-data-ml/secured-argvs
./init.sh
SGX=1 ./pal_loader bash 2>&1 | tee sql_hive_context_example-sgx.log
...
/graphene/Tools/argv_serializer bash -c "/opt/jdk8/bin/java \
  ...
  org.apache.spark.deploy.SparkSubmit \
    ...
    --conf spark.python.use.daemon=false \
    --conf spark.python.worker.reuse=false \
    /ppml/trusted-big-data-ml/work/examples/sql_catalog_example.py" > /ppml/trusted-big-data-ml/secured-argvs
./init.sh
SGX=1 ./pal_loader bash 2>&1 | tee sql_catalog_example-sgx.log
...
/graphene/Tools/argv_serializer bash -c "/opt/jdk8/bin/java \
  ...
  org.apache.spark.deploy.SparkSubmit \
    ...
    --conf spark.python.use.daemon=false \
    --conf spark.python.worker.reuse=false \
    /ppml/trusted-big-data-ml/work/examples/sql_types_example.py" > /ppml/trusted-big-data-ml/secured-argvs
./init.sh
SGX=1 ./pal_loader bash 2>&1 | tee sql_types_example-sgx.log
...
/graphene/Tools/argv_serializer bash -c "/opt/jdk8/bin/java \
      ...
      org.apache.spark.deploy.SparkSubmit \
        ...
        --conf spark.python.use.daemon=false \
        --conf spark.python.worker.reuse=false \
        /ppml/trusted-big-data-ml/work/examples/sql_functions_${f_num}_example.py" > /ppml/trusted-big-data-ml/secured-argvs
./init.sh
SGX=1 ./pal_loader bash 2>&1 | tee sql_functions_${f_num}_example.log
  done
fi
