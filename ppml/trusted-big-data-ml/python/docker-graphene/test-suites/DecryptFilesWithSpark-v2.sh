...
data_key=$(python /ppml/trusted-big-data-ml/work/kms-client/v2/KmsApi.py -api get_data_key_plaintext -ip $KMS_SERVER_IP -pkp ./encrypted_primary_key -dkp ./encrypted_data_key)
