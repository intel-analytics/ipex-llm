...
/graphene/Tools/argv_serializer bash -c "export PYSPARK_PYTHON=/usr/bin/python && \
  ...
  /ppml/trusted-big-data-ml/work/spark-3.1.3/examples/src/main/python/sql/basic.py" > /ppml/trusted-big-data-ml/secured-argvs
./init.sh
...
/graphene/Tools/argv_serializer bash -c "export PYSPARK_PYTHON=/usr/bin/python && \
  ...
  --executor-memory 2g \
  /ppml/trusted-big-data-ml/work/spark-3.1.3/examples/src/main/python/sql/arrow.py" > /ppml/trusted-big-data-ml/secured-argvs
./init.sh
...
/graphene/Tools/argv_serializer bash -c "export PYSPARK_PYTHON=/usr/bin/python && \
  ...
  --executor-memory 2g \
  /ppml/trusted-big-data-ml/work/spark-3.1.3/examples/src/main/python/sql/hive.py" > /ppml/trusted-big-data-ml/secured-argvs
./init.sh
