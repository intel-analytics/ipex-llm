...
gramine-argv-serializer bash -c "/opt/jdk8/bin/java \
  ...
  org.apache.spark.deploy.SparkSubmit \
    ...
    --conf spark.python.worker.reuse=false \
    --conf spark.sql.broadcastTimeout=3000 \
    /ppml/trusted-big-data-ml/work/examples/sql_context_example.py" > secured_argvs
./init.sh
...
gramine-argv-serializer bash -c "/opt/jdk8/bin/java \
  ...
  -Xmx1g \
    ...
    --conf spark.python.use.daemon=false \
    --conf spark.python.worker.reuse=false \
    /ppml/trusted-big-data-ml/work/examples/sql_UDFRegistration_example.py" > secured_argvs
./init.sh
...
gramine-argv-serializer bash -c "/opt/jdk8/bin/java \
  ...
  org.apache.spark.deploy.SparkSubmit \
    ...
    --conf spark.python.use.daemon=false \
    --conf spark.python.worker.reuse=false \
    /ppml/trusted-big-data-ml/work/examples/sql_groupeddata_example.py" > secured_argvs
./init.sh
...
gramine-argv-serializer bash -c "/opt/jdk8/bin/java \
  ...
  org.apache.spark.deploy.SparkSubmit \
    ...
    --conf spark.python.use.daemon=false \
    --conf spark.python.worker.reuse=false \
    /ppml/trusted-big-data-ml/work/examples/sql_column_example.py" > secured_argvs
./init.sh
...
gramine-argv-serializer bash -c "/opt/jdk8/bin/java \
  ...
  org.apache.spark.deploy.SparkSubmit \
    ...
    --conf spark.python.use.daemon=false \
    --conf spark.python.worker.reuse=false \
    /ppml/trusted-big-data-ml/work/examples/sql_row_func_example.py" > secured_argvs
./init.sh
...
gramine-argv-serializer bash -c "/opt/jdk8/bin/java \
  ...
  org.apache.spark.deploy.SparkSubmit \
    ...
    --conf spark.python.use.daemon=false \
    --conf spark.python.worker.reuse=false \
    /ppml/trusted-big-data-ml/work/examples/sql_window_example.py" > secured_argvs
./init.sh
...
gramine-argv-serializer bash -c "/opt/jdk8/bin/java \
  ...
  org.apache.spark.deploy.SparkSubmit \
    ...
    --conf spark.python.use.daemon=false \
    --conf spark.python.worker.reuse=false \
    /ppml/trusted-big-data-ml/work/examples/sql_dataframe_reader_example.py" > secured_argvs
./init.sh
...
gramine-argv-serializer bash -c "/opt/jdk8/bin/java \
  ...
  org.apache.spark.deploy.SparkSubmit \
    ...
    --conf spark.python.use.daemon=false \
    --conf spark.python.worker.reuse=false \
    /ppml/trusted-big-data-ml/work/examples/sql_dataframe_writer_example.py" > secured_argvs
./init.sh
...
gramine-argv-serializer bash -c "/opt/jdk8/bin/java \
  ...
  org.apache.spark.deploy.SparkSubmit \
    ...
    --conf spark.python.use.daemon=false \
    --conf spark.python.worker.reuse=false \
    /ppml/trusted-big-data-ml/work/examples/sql_hive_context_example.py" > secured_argvs
./init.sh
...
gramine-argv-serializer bash -c "/opt/jdk8/bin/java \
  ...
  org.apache.spark.deploy.SparkSubmit \
    ...
    --conf spark.python.use.daemon=false \
    --conf spark.python.worker.reuse=false \
    /ppml/trusted-big-data-ml/work/examples/sql_catalog_example.py" > secured_argvs
./init.sh
...
gramine-argv-serializer bash -c "/opt/jdk8/bin/java \
  ...
  org.apache.spark.deploy.SparkSubmit \
    ...
    --conf spark.python.use.daemon=false \
    --conf spark.python.worker.reuse=false \
    /ppml/trusted-big-data-ml/work/examples/sql_types_example.py" > secured_argvs
./init.sh
...
gramine-argv-serializer bash -c "/opt/jdk8/bin/java \
      ...
      org.apache.spark.deploy.SparkSubmit \
        ...
        --conf spark.python.use.daemon=false \
        --conf spark.python.worker.reuse=false \
        /ppml/trusted-big-data-ml/work/examples/sql_functions_${f_num}_example.py" > secured_argvs
./init.sh
