...
export SPARK_LOCAL_IP=$LOCAL_IP && \
  /opt/jdk8/bin/java \
    ...
    local:///ppml/trusted-big-data-ml/work/spark-$SPARK_VERSION/examples/jars/spark-examples_2.12-$SPARK_VERSION.jar 2>&1 | tee spark-sqlexamples-on-k8s-cluster-sgx.log
