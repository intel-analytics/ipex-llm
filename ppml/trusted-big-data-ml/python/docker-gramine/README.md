...
**Tip:** if you want to skip building the custom image, you can use our public image `intelanalytics/bigdl-ppml-trusted-big-data-ml-python-gramine-reference:2.2.0` for a quick start, which is provided for a demo purpose. Do not use it in production.
