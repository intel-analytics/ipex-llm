...
## Installing
You can use BigDL on [Google Colab](https://bigdl.readthedocs.io/en/branch-2.0/doc/UserGuide/colab.html) without any installation. BigDL also includes a set of [notebooks](https://bigdl.readthedocs.io/en/branch-2.0/doc/UserGuide/notebooks.html) that you can directly open and run in Colab.
...
To install latest nightly build, use ```pip install --pre --upgrade bigdl```; see [Python](https://bigdl.readthedocs.io/en/branch-2.0/doc/UserGuide/python.html) and [Scala](https://bigdl.readthedocs.io/en/branch-2.0/doc/UserGuide/scala.html) user guide for more details.
...
```
See the [NNframes](https://bigdl.readthedocs.io/en/branch-2.0/doc/UseCase/nnframes.html) and [Keras API](https://bigdl.readthedocs.io/en/branch-2.0/doc/UseCase/keras-api.html) user guides for more details.
...
First, initialize [Orca Context](https://bigdl.readthedocs.io/en/branch-2.0/doc/Orca/Overview/orca-context.html):
...
Next, perform [data-parallel processing in Orca](https://bigdl.readthedocs.io/en/branch-2.0/doc/Orca/Overview/data-parallel-processing.html) (supporting standard Spark Dataframes, TensorFlow Dataset, PyTorch DataLoader, Pandas, Pillow, etc.):
...
Finally, use [sklearn-style Estimator APIs in Orca](https://bigdl.readthedocs.io/en/branch-2.0/doc/Orca/Overview/distributed-training-inference.html) to perform distributed _TensorFlow_, _PyTorch_ or _Keras_ training and inference:
...
See [TensorFlow](https://bigdl.readthedocs.io/en/branch-2.0/doc/Orca/QuickStart/orca-tf-quickstart.html) and [PyTorch](https://bigdl.readthedocs.io/en/branch-2.0/doc/Orca/QuickStart/orca-pytorch-quickstart.html) quickstart, as well as the [document website](https://bigdl.readthedocs.io/), for more details.
...
See the RayOnSpark [user guide](https://bigdl.readthedocs.io/en/branch-2.0/doc/Ray/Overview/ray.html) and [quickstart](https://bigdl.readthedocs.io/en/branch-2.0/doc/Ray/QuickStart/ray-quickstart.html) for more details.
...
To train a time series model with AutoML, first initialize [Orca Context](https://bigdl.readthedocs.io/en/branch-2.0/doc/Orca/Overview/orca-context.html):
...
See the Chronos [user guide](https://bigdl.readthedocs.io/en/branch-2.0/doc/Chronos/Overview/chronos.html) and [example](https://bigdl.readthedocs.io/en/branch-2.0/doc/Chronos/QuickStart/chronos-autotsest-quickstart.html) for more details.
...
See the [PPML user guide](https://bigdl.readthedocs.io/en/branch-2.0/doc/PPML/Overview/ppml.html) for more details. 
...
- [Powered-By](https://bigdl.readthedocs.io/en/branch-2.0/doc/Application/powered-by.html)
- [Presentations](https://bigdl.readthedocs.io/en/branch-2.0/doc/Application/presentations.html)
