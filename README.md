...
### Latest update 🔥 
- [2024/02] `bigdl-llm` now supports directly loading model from [ModelScope](https://github.com/jason-dai/BigDL/tree/main/python/llm/example/GPU/ModelScope-Models) ([魔搭](https://github.com/jason-dai/BigDL/tree/main/python/llm/example/CPU/ModelScope-Models)).
