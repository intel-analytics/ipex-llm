...
import com.intel.analytics.bigdl.dllib.nn.tf.{SigmoidGrad => SigmoidGradOps}
...
class SigmoidGrad extends TensorflowOpsLoader {
  override def build[T: ClassTag](nodeDef: NodeDef, byteOrder: ByteOrder,
    ...
    if (t == DataType.DT_FLOAT) {
      ...
      Log4Error.invalidOperationError(false, s"Not support load SigmoidGrad when type is ${t}")
      null
    }
  }
}
