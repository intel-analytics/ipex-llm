...
Yarn Test Suite
   ...
   Run Shell                        ${submit} --master yarn --deploy-mode client --driver-memory 5g --executor-memory 10g --num-executors 1 --executor-cores 8 --class com.intel.analytics.bigdl.dllib.example.nnframes.imageInference.ImageInferenceExample ${jar_path} --caffeDefPath ${integration_data_dir}/models/nnframes/deploy.prototxt --caffeWeightsPath ${integration_data_dir}/models/nnframes/bvlc_googlenet.caffemodel --batchSize 32 --imagePath ${public_hdfs_master}:9000/dogs_cats/samples
   Log To Console                   begin imageTransferLearning
   Run Shell                        ${submit} --master yarn --deploy-mode client --driver-memory 5g --executor-memory 10g --num-executors 1 --executor-cores 8 --class com.intel.analytics.bigdl.dllib.example.nnframes.imageTransferLearning.ImageTransferLearning ${jar_path} --caffeDefPath ${integration_data_dir}/models/nnframes/deploy.prototxt --caffeWeightsPath ${integration_data_dir}/models/nnframes/bvlc_googlenet.caffemodel --batchSize 32 --imagePath ${public_hdfs_master}:9000/dogs_cats/samples --nEpochs 20
