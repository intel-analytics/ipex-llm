...
import com.intel.analytics.bigdl.dllib.nn.internal.{MaxPooling1D, Sequential => KSequential}
...
class MaxPooling1DSerialTest extends ModuleSerializationTest {
  override def test(): Unit = {
    ...
    val input = Tensor[Float](2, 12, 12).apply1(_ => new SecureRandom().nextFloat())
