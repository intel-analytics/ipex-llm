...
import com.intel.analytics.bigdl.dllib.nn.internal.{MaxPooling3D, Sequential => KSequential}
...
class MaxPooling3DSerialTest extends ModuleSerializationTest {
  override def test(): Unit = {
    ...
    val input = Tensor[Float](2, 3, 20, 15, 35).apply1(_ => new SecureRandom().nextFloat())
