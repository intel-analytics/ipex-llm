...
import com.intel.analytics.bigdl.dllib.nn.internal.{AtrousConvolution1D, Sequential => KSequential}
...
class AtrousConvolution1DSerialTest extends ModuleSerializationTest {
  override def test(): Unit = {
    ...
    val input = Tensor[Float](2, 8, 32).apply1(_ => new SecureRandom().nextFloat())
