...
import com.intel.analytics.bigdl.dllib.nn.{BinaryThreshold => BBinaryThreshold}
import com.intel.analytics.bigdl.dllib.keras.layers.{BinaryThreshold => ZBinaryThreshold}
