...
import com.intel.analytics.bigdl.dllib.nn.internal.{Convolution1D, Conv1D, Sequential => KSequential}
...
class Convolution1DSerialTest extends ModuleSerializationTest {
  override def test(): Unit = {
    ...
    val input = Tensor[Float](2, 12, 20).apply1(_ => new SecureRandom().nextFloat())
