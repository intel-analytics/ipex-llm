...
import com.intel.analytics.bigdl.dllib.nn.internal.{Conv3D, Convolution3D, Sequential => KSequential}
...
class Convolution3DSerialTest extends ModuleSerializationTest {
  override def test(): Unit = {
    ...
    val input = Tensor[Float](2, 3, 32, 32, 32).apply1(_ => new SecureRandom().nextFloat())
