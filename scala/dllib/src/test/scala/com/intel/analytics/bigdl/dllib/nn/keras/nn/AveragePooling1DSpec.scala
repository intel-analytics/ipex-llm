...
import com.intel.analytics.bigdl.dllib.nn.internal.{AveragePooling1D, Sequential => KSequential}
...
class AveragePooling1DSerialTest extends ModuleSerializationTest {
  override def test(): Unit = {
    ...
    val input = Tensor[Float](2, 12, 16).apply1(_ => new SecureRandom().nextFloat())
