...
def alexnet_v1_arg_scope(weight_decay=0.0005):
  with slim.arg_scope([slim.conv2d],
                      ...
                      weights_regularizer=slim.l2_regularizer(weight_decay), data_format="NCHW"):
...
def alexnet_v1(inputs,
  ...
  with tf.variable_scope(scope, 'alexnet_v2', [inputs]) as sc:
    ...
    with slim.arg_scope([slim.conv2d, slim.max_pool2d],
                        outputs_collections=[end_points_collection], data_format="NCHW"):
      ...
      with slim.arg_scope([slim.conv2d],
                          ...
                          biases_initializer=tf.constant_initializer(0.1), data_format="NCHW"):
