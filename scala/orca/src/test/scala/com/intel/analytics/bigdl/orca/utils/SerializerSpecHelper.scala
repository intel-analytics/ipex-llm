...
package com.intel.analytics.bigdl.orca.utils.serializer

import java.lang.reflect.Modifier

import com.intel.analytics.bigdl.dllib.nn.abstractnn.AbstractModule
import com.intel.analytics.bigdl.orca.utils.NoKeras2
...
abstract class SerializerSpecHelper extends FlatSpec with Matchers with BeforeAndAfterAll{
  ...
  private val excluded = Set[String](
    ...
    "com.intel.analytics.bigdl.orca.net.TFNet",
    "com.intel.analytics.bigdl.orca.net.TorchModel",
    "com.intel.analytics.bigdl.dllib.keras.layers.internal.Recurrent",
    ...
    "com.intel.analytics.bigdl.orca.tfpark.TFTrainingHelper",
    "com.intel.analytics.bigdl.orca.tfpark.TFTrainingHelperV2",
    "com.intel.analytics.bigdl.orca.net.TFNetForInference",
    "com.intel.analytics.bigdl.orca.tfpark.TFSubGraph")
