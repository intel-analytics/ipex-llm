...
class FriesianRedisSpec extends ZooSpecHelper {
  ...
  "Lettuce utils cluster 1" should "work properly" in {
    ...
    val utils = LettuceUtils.getInstance(RedisType.CLUSTER, hostPort, "cluster",
      null, null, 1)
    val data = Array(Array("1", "11"), Array("2", "12"), Array("3", "13"), Array("4", "14"), Array("5", "15"),
      Array("6", "16"), Array("7", "17"), Array("8", "18"), Array("9", "19"), Array("10", "110"))
  ...
  "Lettuce utils cluster 2" should "work properly" in {
    ...
    val utils = LettuceUtils.getInstance(RedisType.CLUSTER, hostPort, "cluster",
      null, null, 2)
    val data = Array(Array("1", "21"), Array("2", "22"), Array("3", "23"), Array("4", "24"), Array("5", "25"),
