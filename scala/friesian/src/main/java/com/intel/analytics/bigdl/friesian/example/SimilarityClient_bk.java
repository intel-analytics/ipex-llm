...
public class SimilarityClient_bk {
    private static final Logger logger = LogManager.getLogger(SimilarityClient_bk.class.getName());
    private final SimilarityGrpc.SimilarityBlockingStub blockingStub;

    public SimilarityClient_bk(Channel channel) {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        SimilarityClient_bk client = new SimilarityClient_bk(channel);
