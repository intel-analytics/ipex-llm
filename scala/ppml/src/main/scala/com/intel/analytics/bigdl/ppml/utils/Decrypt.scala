...
object Decrypt extends Supportive {

  def main(args: Array[String]): Unit = {
    val arguments = argumentsParser.parse(args, DecryptArguments()) match {
  ...
  val argumentsParser =
    new scopt.OptionParser[DecryptArguments]("PPML Decrypt Arguments") {
...
case class DecryptArguments(inputDataSourcePath: String = "input_data_path",
