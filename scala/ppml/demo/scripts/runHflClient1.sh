...
/graphene/Tools/argv_serializer bash -c "/opt/jdk8/bin/java -Xms2g -Xmx2g -XX:ActiveProcessorCount=4 -cp \
  ...
  com.intel.analytics.bigdl.ppml.fl.example.HFLLogisticRegression -d \
  /ppml/trusted-big-data-ml/work/data/diabetes-hfl-1.csv" > /ppml/trusted-big-data-ml/secured-argvs
