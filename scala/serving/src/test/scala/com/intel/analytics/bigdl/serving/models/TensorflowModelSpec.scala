...
class TensorflowModelSpec extends FlatSpec with Matchers {
  ...
  "Tensorflow Inception v1" should "work" in {
    ("wget -O /tmp/tensorflow_inception_v1.tar https://sourceforge.net/projects/analytics-zoo/files/analytics-zoo-data/tensorflow_inception_v1.tar").!
  ...
  "Tensorflow MobileNet v1" should "work" in {
    ("wget -O /tmp/tensorflow_mobilenet_v1.tar https://sourceforge.net/projects/analytics-zoo/files/analytics-zoo-data/tensorflow_mobilenet_v1.tar").!
  ...
  "TensorflowModel MobileNet v2" should "work" in {
    ("wget -O /tmp/tensorflow_mobilenet_v2.tar https://sourceforge.net/projects/analytics-zoo/files/analytics-zoo-data/tensorflow_mobilenet_v2.tar").!
  ...
  "TensorflowModel ResNet 50" should "work" in {
    ("wget -O /tmp/tensorflow_resnet50.tar https://sourceforge.net/projects/analytics-zoo/files/analytics-zoo-data/tensorflow_resnet50.tar").!
  ...
  "TensorflowModel tf auto" should "work" in {
    ("wget -O /tmp/tensorflow_tfauto.tar https://sourceforge.net/projects/analytics-zoo/files/analytics-zoo-data/tensorflow_tfauto.tar").!
  ...
  "TensorflowModel VGG16" should "work" in {
    ("wget -O /tmp/tensorflow_vgg16.tar https://sourceforge.net/projects/analytics-zoo/files/analytics-zoo-data/tensorflow_vgg16.tar").!
  ...
  "TensorflowModel tf_2out" should "work" in {
    ("wget -O /tmp/tensorflow_tf_2out.tar https://sourceforge.net/projects/analytics-zoo/files/analytics-zoo-data/tensorflow_tf_2out.tar").!
  ...
  "TF String input" should "work" in {
    ("wget -O /tmp/tf_string.tar https://sourceforge.net/projects/analytics-zoo/files/analytics-zoo-data/tf_string.tar").!
