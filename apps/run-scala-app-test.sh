...
# if [ -f /tmp/recommendation/ncf.bigdl ]
# then
#     echo "/tmp/recommedation/ncf.bigdl already exists"
# else
#     wget $FTP_URI/analytics-zoo-models/recommendation/ncf.bigdl -P /tmp/recommendation/
# fi
...
# -DMODEL_PATH=./tmp/recommendation/ncf.bigdl \
...
# then
#     echo "/tmp/flink_model/mobilenet_v1_1.0_224_frozen.pb already exists"
# else
