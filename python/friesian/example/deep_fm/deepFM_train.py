...
if __name__ == '__main__':
    ...
    print(train.select("engaged_with_user_id").cast("engaged_with_user_id", "str").df.Map(lambda x:x).rdd.collect())
    print(test.select("engaged_with_user_id").cast("engaged_with_user_id", "str").df.Map(lambda x:x).rdd.collect())
