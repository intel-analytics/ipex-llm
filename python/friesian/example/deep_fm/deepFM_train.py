...
if __name__ == '__main__':
    ...
    print(train.select("engaged_with_user_id").cast("engaged_with_user_id", "str").df.rdd.flatMap(lambda x:x).collect())
    print(test.select("engaged_with_user_id").cast("engaged_with_user_id", "str").df.rdd.flatMap(lambda x:x).collect())
