...
if __name__ == '__main__':
    ...
    print(train.select("engaged_with_user_id").cast("engaged_with_user_id", "str").df.rdd.collectAsMap())
    print(test.select("engaged_with_user_id").cast("engaged_with_user_id", "str").df.rdd.collectAsMap())
