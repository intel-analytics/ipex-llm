...
enaging_user_df = full_tbl.select(['enaging_user_id',
...
engaged_user_df = full_tbl.select(['engaged_with_user_id',
...
user_embed = FeatureTable(enaging_user_embed).concat(FeatureTable(engaged_user_embed))\
