...
__Note:__ As we test, Spark 3 will have performance benefit over the default Spark 2.4.6 and you can install BigDL Friesian built with Spark 3.1.2 using `pip install --pre --upgrade bigdl-friesian-spark3`.
