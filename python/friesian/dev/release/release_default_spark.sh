...
# This is the default script with maven parameters to release bigdl-friesian built on top of Spark for linux or mac.
...
if (( $# < 4)); then
  ...
  echo "Usage example: bash release_default_spark.sh linux default true true 3.1.3 true"
