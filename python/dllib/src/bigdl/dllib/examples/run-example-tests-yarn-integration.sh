...
# start=$(date "+%s")
# #run the example
# python ${BIGDL_ROOT}/python/orca/example/learn/pytorch/cifar10/cifar10.py --cluster_mode 'yarn-client' --epochs 1  --batch_size 256
# exit_status=$?
# if [ $exit_status -ne 0 ]; then
#   #clear_up
...
start=$(date "+%s")
#run the example
python ${BIGDL_ROOT}/python/orca/example/torchmodel/train/imagenet/main.py  ${HDFS_URI}/imagenet_jpeg --max_epochs 1  --batch-size 4 
exit_status=$?
if [ $exit_status -ne 0 ]; then
  #clear_up
...
# start=$(date "+%s")
# #run the example
# python ${BIGDL_ROOT}/python/orca/example/torchmodel/train/mnist/main.py  --deploy-mode 'yarn-client' --epochs 1  --batch-size 256
# exit_status=$?
# if [ $exit_status -ne 0 ]; then
#   #clear_up
