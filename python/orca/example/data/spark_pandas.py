...
if __name__ == "__main__":
    ...
    parser.add_option("--deploy-mode", type=str, dest="deployMode", default="yarn-client", help="deploy mode, spark-submit, yarn-client or yarn-cluster")
    (options, args) = parser.parse_args(sys.argv)

    sc = init_orca_context(cluster_mode=options.deploy-mode,cores="*", memory="4g")
