...
init_orca_context(cores=4, memory="8g")
...
est = Estimator.from_torch(model=model_creator, optimizer=optimizer_creator,loss=loss_function, metrics=[Accuracy()],backend="spark",model_dir=Config["model_dir"])
