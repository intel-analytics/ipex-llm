...
#run the example
python ${BIGDL_ROOT}/python/orca/example/torchmodel/resnet_finetune/resnet_finetune.py --imagePath analytics-zoo-data/data/cats_and_dogs_filtered/samples
exit_status=$?
...
echo "#5 orca bigdl resnet-finetune time used:$time3 seconds"
