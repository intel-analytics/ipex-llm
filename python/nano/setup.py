...
def setup_package():
    ...
    tensorflow_212_requires = ["intel-tensorflow==2.12.0; (platform_machine=='x86_64' or platform_machine == 'AMD64') and \
                               platform_system!='Darwin'",
                               "tensorflow==2.12.0; platform_machine=='x86_64' and \
                               platform_system=='Darwin'"]
    ...
    metadata = dict(
        ...
        extras_require={"tensorflow": tensorflow_requires,
                        ...
                        "tensorflow_212": tensorflow_212_requires,
                        ...
                        "stock_tensorflow_212": stock_tensorflow_212_requires,
