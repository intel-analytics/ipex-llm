...
class QuantizationINC:
    def __init__(self,
        ...
        :param framework:   Supported values are tensorflow, pytorch, pytorch_fx, pytorch_ipex,
                            ...
                            Quantization.
        :param conf:        A path to conf yaml file for quantization. Default: None, use default config.
        :param approach:    post_training_static_quant, post_training_dynamic_quant, quant_aware_training.
                            Default: post_training_static_quant.
        :param strategy:    bayesian, basic, mse, sigopt. Default: bayesian.
        :param accuracy_criterion:  Tolerable accuracy drop.
                                    accuracy_criterion = {'relative': 0.1, higher_is_better=True} allows relative
        ...
        :param max_trials:  Max tune times. Default: 1. combine with timeout field to decide when to exit.
