...
class PytorchONNXRuntimeModel(ONNXRuntimeModel, AcceleratedLightningModule):
    ...
    def __init__(self, model, input_sample=None, onnxruntime_session_options=None, opset_version=11):
        """
        ...
        if isinstance(model, torch.nn.Module):
            ...
            export_to_onnx(model, input_sample=input_sample, onnx_path='tmp.onnx', opset_version=opset_version)
            onnx_path = 'tmp.onnx'
