...
class ONNXRuntimeModel:
    ...
    def forward_step(self, *inputs):
        ...
        '''
        invalidInputError(len(self._forward_args) >= len(inputs), "The length of inputs is inconsistent with "
                          "the length of ONNX Runtime session's inputs, there may be some redundant inputs.")
