...
# here the prompt tuning refers to https://huggingface.co/internlm/internlm-chat-20b/blob/main/modeling_internlm.py#L773
INTERNLM_PROMPT_FORMAT = "<|User|>:{prompt}<eoh>\n<|Bot|>:"

if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Predict Tokens using `generate()` API for InternLM model')
    parser.add_argument('--repo-id-or-model-path', type=str, default="internlm/internlm-chat-20b",
