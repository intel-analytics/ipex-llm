...
from bigdl.llm.transformers.lora import cast_base_and_lora_weight, preprare_gradient_checkpointing
...
def train(
    # model/data params
    base_model: str = "meta-llama/Llama-2-7b-hf",  # the only required argument, default to be "mistralai/Mixtral-8x7B-v0.1"
    ...
    if gradient_checkpointing:
        preprare_gradient_checkpointing(model)
    ...
    cast_base_and_lora_weight(model)
