...
## Requirements
To apply Intel GPU acceleration, there’re several steps for tools installation and environment preparation. See the [GPU installation guide](../../../../docs/mddocs/Overview/install_gpu.md) for mode details.