...
A question that gets to the heart of what I am!

Artificial Intelligence (AI) refers to the development of computer systems that can perform tasks that would typically
```
