...
class BenchmarkWrapper:
    ...
    def greedy_search(
        ...
        **model_kwargs,
        ...
        #     on_trace_ready=torch.profiler.tensorboard_trace_handler('qwen_cpu'),
        #     record_shapes=True,
        #     profile_memory=True,
        #     with_stack=True)
        # prof.start()
        while True:
            ...
            do_profiling = False
            with torch.autograd.profiler_legacy.profile(do_profiling, use_xpu=True, record_shapes=False) as prof_xpu:
                outputs = self(
                    **model_inputs,
                    return_dict=True,
            ...
            if do_profiling:
                print(prof_xpu.key_averages().table(sort_by="self_xpu_time_total"))
