# Image Captioning
In this example, you will find how you could apply BigDL-LLM INT4 optimizations to [HuggingFace Transformers Agents](https://huggingface.co/docs/transformers/transformers_agents) and generate captions using the image captioning tool.
