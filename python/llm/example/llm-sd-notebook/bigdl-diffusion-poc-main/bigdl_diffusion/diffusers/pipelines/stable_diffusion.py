...
from bigdl_diffusion.common.optimize import load_optimized_unet, load_optimized_vae_decoder
from bigdl_diffusion.utils.paths import *
import functools
...
def _preload_ov(pretrained_model_name_or_path, device, precision):
    from bigdl_diffusion.diffusers.modules import NanoUNet
