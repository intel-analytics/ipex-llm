...
async def tokenize(request: TokenizeRequest):
    ...
    if isinstance(generator, ErrorResponse):
        ...
        assert isinstance(generator, TokenizeResponse)  # noqa
...
async def detokenize(request: DetokenizeRequest):
    ...
    if isinstance(generator, ErrorResponse):
        ...
        assert isinstance(generator, DetokenizeResponse)  # noqa
        return JSONResponse(content=generator.model_dump())
...
async def create_chat_completion(request: ChatCompletionRequest, raw_request: Request):
    ...
    if request.stream:
        ...
        assert isinstance(generator, ChatCompletionResponse)  # noqa
        return JSONResponse(content=generator.model_dump())
...
def run_server(args, llm_engine=None):
    ...
    openai_serving_tokenization = OpenAIServingTokenization(
        engine, model_config, served_model_names, args.lora_modules, args.chat_template
    )
    app.root_path = args.root_path
