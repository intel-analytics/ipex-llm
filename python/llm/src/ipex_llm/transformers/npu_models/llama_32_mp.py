    ...
    def __init__(
        ...
        *shapes,
        ...
        if mode == "prefill":
            ...
            cos = self.create_input_op((self.batch_size, 28, self.head_dim))
            sin = self.create_input_op((self.batch_size, 28, self.head_dim))
        else:
            cos = self.create_input_op((self.batch_size, 1, self.head_dim))
            sin = self.create_input_op((self.batch_size, 1, self.head_dim))
        ...
        for i in range(num_layers):
            hidden_states, new_key_states, new_value_states = self.build_decoder(
                ...
                position_ids=position_ids if mode == "prefill" else None,
