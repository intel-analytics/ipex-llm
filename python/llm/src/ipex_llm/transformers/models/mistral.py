...
from ipex_llm.transformers.models.utils import use_flash_attention, use_esimd_sdp, use_sdp_fp8
...
def mistral_attention_forward_original(
    ...
    if fsdp_flag:
        ...
        attn_output = attn_output.transpose(1, 2).contiguous()
        attn_output = attn_output.reshape(bsz, q_len, self.hidden_size)
    elif use_esimd_sdp(q_len, key_states.shape[2], self.head_dim, query_states, legacy_sdp=False):
