...
# https://github.com/huggingface/transformers/blob/v4.36.0/src/transformers/models/mixtral/modeling_mixtral.py
# coding=utf-8
...
def mixtral_sparse_moe_block_forward(self, hidden_states: torch.Tensor) -> torch.Tensor:
    ...
    if sequence_length == 1 and hidden_states.device.type == "xpu":
        import linear_q4_0
