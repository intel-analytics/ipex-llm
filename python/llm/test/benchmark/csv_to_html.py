...
def main():
    ...
    if len(csv_files)>1:
        ...
        latest_csv.insert(loc=7,column='best last1',value=best_last1)
        latest_csv.insert(loc=8,column='best diff1(%)',value=best_diff1)
        latest_csv.insert(loc=9,column='best last2',value=best_last2)
        ...
        columns={'1st token avg latency (ms)': '{:.2f}', '2+ avg latency (ms/token)': '{:.2f}', 'last1': '{:.2f}', 'diff1(%)': '{:.2f}',
                ...
                'best last1': '{:.2f}', 'best diff1(%)': '{:.2f}', 'best last2': '{:.2f}', 'best diff2(%)': '{:.2f}'}
