...
def setup_package():
    metadata = dict(
        ...
        extras_require={'pytorch': ['bigdl-nano[pytorch]=='+VERSION],
                        ...
                        'all':['bigdl-nano[pytorch]=='+VERSION,  # 'bigdl-nano[tensorflow]=='+VERSION,
                               'optuna<=2.10.1', 'configspace<=0.5.0', 'bigdl-orca[automl]=='+VERSION, 'pmdarima==1.8.5',
                               'prophet==1.1.0', 'tsfresh==0.17.0', 'pyarrow==6.0.1', 'onnx>=1.8.0, <=1.11.0',
                               'onnxruntime>=1.6.0, <=1.11.1', 'openvino-dev==2022.1.0',
                               'neural-compressor>=1.8.1, <=1.11', 'onnxruntime-extensions==0.4.2']},
