...
class TestChronosModelLSTMForecaster(TestCase):
    ...
    @op_diff_set_all
    def test_lstm_forecaster_jit_methods(self):
        train_data, val_data, test_data = create_data()
        forecaster = LSTMForecaster(past_seq_len=24,
                                    input_feature_num=2,
                                    output_feature_num=2,
    ...
    def test_lstm_forecaster_export_torchscript_module(self):
        import shutil
        import pandas as pd
        ...
        forecaster.export_torchscript_module(train_data, path_dir=pipeline_module_dir, drop_dtcol=True)
